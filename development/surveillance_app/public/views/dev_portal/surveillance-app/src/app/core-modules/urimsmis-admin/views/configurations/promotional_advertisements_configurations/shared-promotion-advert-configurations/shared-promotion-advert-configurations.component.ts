...
@Component({
  selector: 'app-shared-promotion-advert-configurations',
  templateUrl: './shared-promotion-advert-configurations.component.html',
  styleUrl: './shared-promotion-advert-configurations.component.css'
})
export class SharedPromotionAdvertConfigurationsComponent {
