...
@Component({
  selector: 'app-dms-nonstructured-docrequirement',
  templateUrl: './dms-nonstructured-docrequirement.component.html',
  styleUrl: './dms-nonstructured-docrequirement.component.css'
})
export class DmsNonstructuredDocrequirementComponent {
  table_name: string = 'dms_nonstructured_docrequirement';
  parameter_name: string = "nonstructured-docrequirement";
  resetcolumns: string;
  ...
  onFuncSaveCountriesData() {
    ...
    this.dmsService.onSaveDocumentDetailsDetails(this.table_name, this.createNewDataFrm.value, 'onSaveDMSNonStructuredDocdefinationdetails')
      .subscribe(
        response => {
