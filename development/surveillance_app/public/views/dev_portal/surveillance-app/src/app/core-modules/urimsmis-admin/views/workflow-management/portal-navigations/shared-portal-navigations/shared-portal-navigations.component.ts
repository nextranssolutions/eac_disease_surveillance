...
import { PortalConfigurationsService } from 'src/app/core-services/portal-configurations/portal-configurations.service';

@Component({
  selector: 'app-shared-portal-navigations',
  templateUrl: './shared-portal-navigations.component.html',
  styleUrl: './shared-portal-navigations.component.css'
})
export class SharedPortalNavigationsComponent {
  ...
  constructor(
    ...
    public portalConfigurationService: PortalConfigurationsService,
  ...
  ngOnInit() {
    ...
    if (this.table_name == 'ptl_navigation_items') {
  ...
  fetchAppNavigationMenus() {
    ...
    this.portalConfigurationService.getAppPortalNavigationMenus().subscribe(
      (data) => {
  ...
  onLoadnavigationLevelsData() {
    var data_submit = {
      'table_name': 'ptl_navigation_levels'
    }
    this.portalConfigurationService.getPortalConfigWorkflow(data_submit)
      .subscribe(
        data => {
  ...
  onLoadAppSystemInterfaceData() {
    var data_submit = {
      'table_name': 'ptl_system_interfaces'
    }
    this.portalConfigurationService.getPortalConfigWorkflow(data_submit)
      .subscribe(
        data => {
  ...
  onLoadnavigationTypesData() {
    var data_submit = {
      'table_name': 'ptl_navigation_types'
    }
    this.portalConfigurationService.getPortalConfigWorkflow(data_submit)
      .subscribe(
        data => {
  ...
  onDeletePortalWorkflowsDetails() {
    this.spinner.show();
    this.portalConfigurationService.onDeletePortalWorkflowsDetails(this.navigationItemsFrm.value, this.table_name, this.parameter_name)
      .subscribe(
        response => {
          this.spinner.hide();
          this.response = response;
