...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            ...
            'name' => env('FIREWALL_EMAIL_NAME', 'e-CRES Laravel Firewall'),
            'from' => env('FIREWALL_EMAIL_FROM', 'system.notifications@nextranssolutions.co.ke'),
            'to' => env('FIREWALL_EMAIL_TO', 'admin@nextranssolutions.co.ke'),
